public class MyLinkedList {
	...
	private MyLinkedList reverse(ListNode node) {
         ...
         reverseAppender(node, result);
         
         return result; // change this line of code as needed
		
	}
	 private void reverseAppender(ListNode node, MyLinkedList result) {
         if(node != null) {
                 reverseAppender(node.next, result);
	...
	private ListNode reverse(ListNode first, ListNode second) {
      ...
      ListNode remainingReversed = reverse(second, second.next);
      second.next = first;
      first.next = null;
      
      return remainingReversed; // change this line of code as needed.	
